# coding=UTF-8
# 基于CART算法构造decision tree用于分类

"""
 @Time    : 2022/02/20 09:58
 @Author  : WeiWei
 @Email   : weiwei_519@outlook.com
 @File    : cart-classify-tree.py
 @Software: PyCharm
"""
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    df_data = pd.read_csv('./data/loan_apply.csv', encoding='gb18030')
    ...
    # 画出决策树
    # createPlot(dt_Gini)
    treePlotter.createPlot(dt_Gini)
